                  ...
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <div class="notify-icon">
                        <img :src="user2" class="img-fluid rounded-circle" alt="" />
                      </div>
                    </div>
                    <div class="flex-grow-1 text-truncate ms-2">
              ...
              <a href="javascript:void(0);" class="dropdown-item p-0 notify-item card read-noti shadow-none mb-1">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <div class="notify-icon">
                        <img :src="user4" class="img-fluid rounded-circle" alt="" />
                      </div>
                    </div>
                    <div class="flex-grow-1 text-truncate ms-2">
...
export default {
  ...
  setup(props) {
    ...
    const userRole = computed(() => 'Usuário')

    // Debug: verificar se as props estão chegando
    console.log('Topbar props:', { user1: props.user1, user2: props.user2, user4: props.user4 })
